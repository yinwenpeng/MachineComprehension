...
from common_functions import GRU_Tensor3_Input, GRU_Matrix_Input,Bi_GRU_Tensor3_Input, Bi_GRU_Matrix_Input, Average_Pooling_for_Top, create_GRU_para, create_Bi_GRU_para, Average_Pooling, create_highw_para, Average_Pooling_Scan, create_HiddenLayer_para, create_ensemble_para
